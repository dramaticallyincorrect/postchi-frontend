    ...
    <div class="pricing-page-container">
      ...
      <div class="pricing-grid w-full flex flex-row gap-6 m-4 items-stretch justify-center">
        <div v-for="item in products" :key="item.id"
             class="w-full max-w-sm flex flex-col p-6 bg-white border border-neutral-200 rounded-lg shadow-xs ">
          <h5 class="mb-4 text-xl font-medium self-start px-5 py-2 rounded-lg bg-secondary text-onsecondary ">{{
              item.name
            }}</h5>
